...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (challenger-deep-theme eziam-theme liso-theme nimbus-theme nord-theme oceanic-theme sexy-monochrome-theme sourcerer-theme company-c-headers sr-speedbar ggtags w3m exwm exwm-x slime slime-company zenburn-theme yasnippet skewer-less paredit muse markdown-mode magit js3-mode flycheck ess engine-mode elfeed company-web company-statistics company-go cmake-project clojure-mode-extra-font-locking cider beacon auctex anzu anti-zenburn-theme)))
